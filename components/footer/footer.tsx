    ...
    <div className='padding-global bg-[#1b2528]'>
        <footer className="footer  text-base-content p-10" style={{borderBottom:'1px solid grey'}}>
            <aside>
                ...
                <strong>Burning Jobs</strong>
                </h1>
                <p>
                A brand of <strong className='text-[#fff]'>Exemplar Global Resources Pvt Ltd</strong>
                </p>
            </aside>
            <nav>
            ...
            <nav>
                ...
                <a className="link link-hover text-[#fff]">Watsapp</a>
            </nav>
        </footer>
        <footer className='footer footer-center p-4 flex text-base-content' style={{justifyContent:'space-between'}}> { /* bg-base-300 */}
            ...
            <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
                ...
                <a href='https://www.instagram.com/burningjobs/'className='hov' target='_blank'>
                ...
                <a href='https://www.linkedin.com/company/burning-jobs-career/about/' className='hov'target='_blank'>
                <svg xmlns="http://www.w3.org/2000/svg" 
                width={24}
                height={24}
                fill='#fff'
                ...
                <a href='https://www.youtube.com/@BurningJobs' className='hov'target='_blank'>
                <svg xmlns="http://www.w3.org/2000/svg" 
                width={24}
                height={24}
                fill='#fff'
