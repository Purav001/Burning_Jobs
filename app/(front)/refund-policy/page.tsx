export default async function RefundPolicy() {
  return (
    <div className="container my-10 mx-auto md:px-6">
      <h2 className="mb-5 text-center text-4xl font-bold text-[#1b2528]">
        Refund policy
      </h2>
      <p className=" mb-5  text-[#1b2528]">
      ...
      <h2 className="  font-bold text-[#1b2528]">Exchanges and Returns</h2>
      <p className="mb-5   text-[#1b2528]">
      ...
      <span className="text-[#1b2528] font-bold">Note:</span>
      <p className="text-[#1b2528] mb-5">
        In case of any quality issue, kindly contact us on +91 8198985878 or
        drop a mail to us at customer@nanibilonaghee.
      </p>

      <h2 className=" font-bold text-[#1b2528]">Cancellation:</h2>
      ...
      <h2 className=" font-bold text-[#1b2528]">Refunds:</h2>
      <p className="text-[#1b2528]">
