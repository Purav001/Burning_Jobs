      ...
      <section className="mb-16">
        ...
        <div className="mb-16 flex flex-wrap items-center">
          ...
          <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">
            ...
            <p className="mb-6 text-[#854e23] font-bold">
              Farmers all over the world like this cow because it&apos;s tough
              and makes a lot of milk.
            </p>
            <p className="mb-6 text-[#854e23] font-bold">
              At Nani&apos;s Bilona Ghee, we make sure our Sahiwal cows stay
              healthy by feeding them good food from our farms.
            </p>
            <p className="mb-6 text-[#854e23] font-bold">
        ...
        <div className="mb-16 flex flex-wrap lg:flex-row-reverse items-center">
          ...
          <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">
            ...
            <p className="mb-6 text-[#854e23] font-bold">
              At Nani&apos;s Bilona Ghee, we exclusively use A2 hormone-free
              milk sourced from Sahiwal cows in crafting our premium ghee.
            </p>
            <p className="mb-6 text-[#854e23] font-bold">
            ...
            <p className="mb-6 text-[#854e23] font-bold">
              Experience the difference with Nani&apos;s Bilona Ghee, where
              tradition meets purity, thanks to our commitment to using A2
              hormone-free milk from Sahiwal cows.
            </p>
          </div>
        </div>
        ...
        <div className="mb-16 flex flex-wrap items-center">
          ...
          <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">
            <h3 className="mb-4 text-2xl font-bold text-[#1b2528]">Curd</h3>
            <p className="mb-6 text-[#854e23] font-bold">
        ...
        <div className="mb-16 flex flex-wrap lg:flex-row-reverse items-center">
          ...
          <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:pl-6">
            ...
            <p className="mb-6 text-[#854e23] font-bold">
              The Aryurvedic Bilona Method, practiced at Nani&apos;s Bilona
              Ghee, involves churning curd made from A2 cow milk in a
              traditional wooden churner called bilona.
            </p>
            <p className="mb-6 text-[#854e23] font-bold">
