...
const PayOnlineAmount = totalPrice
...
if (loading1)
    return (
    <div className="h-full flex justify-center items-center w-full"style={{paddingTop:'100px'}}>
...
return (
    ...
    <div className="grid md:grid-cols-4 md:gap-5 my-4 md:mx-10" style={{paddingTop:'100px'}}>
        ...
        <div className="card">
            ...
            {!isPaid && (
                ...
                Our Team will Contact you within 24 hours once the payment
