  ...
  return (
    <div className="container my-10 mx-auto md:px-6">
      ...
      <p className="mb-5   text-[#1b2528] text-sm md:text-base">
        This website is operated by NANI&apos;S BILONA GHEE (Proprietorship).
        Throughout the site, the terms “we”, “us” and “our” refer to NANI&apos;S
        BILONA GHEE. NANI&apos;S BILONA GHEE offers this website, including all
